...
trigger ContactTrigger on Contact (after insert) {
    ...
    if(Trigger.isInsert && Trigger.isAfter){
        ...
        //exemplo usando list
        List<Account> accountList = new List<Account>([SELECT Id FROM Account WHERE Id IN : idsContasSet]);

        //Exemplo do Map
        Map<Id, Account> accountMap = new Map<Id, Account>([SELECT Id FROM Account WHERE Id IN :idsContasSet]);
